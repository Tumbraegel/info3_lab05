	...
	public static Collection<	Object[]> data() {
		...
		data.addAll(Arrays.asList(new Object[][] { 
					...
					*/
					...
					"Sulfuras, Hand of Ragnaros", 1, 1, 1, 1},  //なぜ4つめが1なのかわからない。→untachable item. sell-in must not be changed.
					...
					/*
					{"12,  some test",
					"Conjured Mana Cake", 1, 48, 0, 49},
					
					{"13,  some test",
					"Elixir of the Mongoose", 1, 48, 0, 49},
					*/
					
					{"12,  For Aged Brie, mark 01 else. steht nicht in der Spezifikation",
					"Aged Brie", 0, 46, -1, 48}, //see 14. not only for Aged Brie but for every item
					
					{"13,  mark02. The Quality of an item is never more than 50",
					"Aged Brie", 0, 50, -1, 50},
					
					{"14,  any item which sell in date を過ぎたもの. ",
